...
extern HsInt32 fmi2Terminate(HsStablePtr a1);
extern HsInt32 fmi2FreeInstance(HsStablePtr a1);
...
extern HsInt32 fmi2GetReal(HsStablePtr a1, HsPtr a2, HsWord64 a3, HsPtr a4);
